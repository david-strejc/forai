...
//FORAI:F3158;DEF[C2648:App];IMP[unknown:Events,unknown:View as BullView,unknown:Factory as BullFactory,unknown:container,unknown:Backbone,unknown:Base64,unknown:Ui,unknown:Utils,unknown:AclManager,unknown:Cache,unknown:Storage,unknown:Settings,unknown:Language,unknown:Metadata,unknown:FieldManager,unknown:User,unknown:Preferences,unknown:ModelFactory,unknown:CollectionFactory,unknown:BaseController,unknown:Router,unknown:DateTime,unknown:LayoutManager,unknown:ThemeManager,unknown:SessionStorage,unknown:ViewHelper,unknown:WebSocketManager,unknown:Ajax,unknown:NumberUtil,unknown:PageTitle,unknown:BroadcastChannel,unknown:uiAppInit,unknown:AppParams];EXP[C2648];LANG[javascript]//
